...
<body class="registeration-wrapper"
	...
	<div class="container my-5 bg-white rounded-3">
		<div class="row">
			...
			<div class="col-md-7">
				<form action="{{route('login_accepted')}}" method="POST" class="text-center h-100 px-3 d-flex flex-column justify-content-center">
				@csrf
				<h3 class="fw-semibold mb-5">LOGIN FORM</h3>
					...
					<a href="register.blade.php" class="fw-semibold fs-6 text-decoration-none text-dark">New User?</a>
				</form>
			</div>
		</div>
	</div>
