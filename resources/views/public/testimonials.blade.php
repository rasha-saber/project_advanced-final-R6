                        ...
                        <div class="carousel-inner">
                                ...
                                <div class="row mx-md-5">
                                    <div class="col-md-4 testimonials">
                                        <img class="d-block rounded-3"
                                            src="{{asset('images/testimonials/janis-dzenis-jkvE9uJN3jk-unsplash.jpg')}}"
                                            alt="First slide">
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="row mx-md-5">
                                    <div class="col-md-4 testimonials">
                                        <img class="d-block rounded-3"
                                            src="{{asset('images/testimonials/janis-dzenis-oPRubjbiqKI-unsplash.jpg')}}"
                                            alt="First slide">
                                    </div>
                                    <div class="col-md-8 px-md-5 d-flex flex-column justify-content-center">
                                        <h3>Jone Due<br><strong class="date">12/02/2019</strong></h3>
                            ...
                            <div class="carousel-item">
                                <div class="row mx-md-5">
                                    <div class="col-md-4 testimonials">
                                        <img class="d-block rounded-3"
                                            src="{{asset('/images/testimonials/rocky-xiong-UE04nFCgDUE-unsplash.jpeg')}}"
                                            alt="First slide">
                                    </div>
                                    <div class="col-md-8 px-md-5 d-flex flex-column justify-content-center">
                                        <h3>Jone Due<br><strong class="date">12/02/2019</strong></h3>
